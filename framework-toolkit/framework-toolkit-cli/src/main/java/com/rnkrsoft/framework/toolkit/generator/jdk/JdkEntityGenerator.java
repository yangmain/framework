 ...
 */
public class JdkEntityGenerator implements EntityGenerator{
    @Override
    public ByteBuf generate(GenerateContext ctx) {
        ...
        for (String columnName : metadata.getOrderColumns()){
            ...
            if (columnMetadata.getJdbcType().equals("VARCHAR")){
                buf.put("UTF-8", MessageFormatter.format("  @StringColumn(name = \"{}\", nullable={}, type = StringType.VARCHAR)", columnMetadata.getJdbcName(), columnMetadata.getNullable()), "\n");
                buf.put("UTF-8", MessageFormatter.format("  String {};", columnMetadata.getJavaName()));
            }else if(columnMetadata.getJdbcType().equals("CHAR")){
                buf.put("UTF-8", MessageFormatter.format("  @StringColumn(name = \"{}\", nullable={}, type = StringType.CHAR))", columnMetadata.getJdbcName(), columnMetadata.getNullable()), "\n");
                buf.put("UTF-8", MessageFormatter.format("  String {};", columnMetadata.getJavaName()));
            }else if(columnMetadata.getJdbcType().equals("NUMERIC")){
                buf.put("UTF-8", MessageFormatter.format("  @NumberColumn(name = \"{}\", nullable= {}, type = NumberType.INTEGER)", columnMetadata.getJdbcName(), columnMetadata.getNullable()), "\n");
                ...
                buf.put("UTF-8", MessageFormatter.format("  @NumberColumn(name = \"{}\", nullable= {}, type = NumberType.DECIMAL )", columnMetadata.getJdbcName(), columnMetadata.getNullable()), "\n");
                ...
                buf.put("UTF-8", MessageFormatter.format("  @DateColumn(name = \"{}\", nullable= {}, type = DateType.DATE)", columnMetadata.getJdbcName(), columnMetadata.getNullable()), "\n");
                ...
                buf.put("UTF-8", MessageFormatter.format("  @DateColumn(name = \"{}\", nullable= {}, type = DateType.TIMESTAMP)", columnMetadata.getJdbcName(), columnMetadata.getNullable()), "\n");
