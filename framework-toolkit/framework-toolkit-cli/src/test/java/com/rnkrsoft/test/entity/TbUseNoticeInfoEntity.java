...
@AllArgsConstructor
@ToString
@Table(name = "tb_use_notice_info")
@Comment("用户使用情况通知表")
public class TbUseNoticeInfoEntity implements Serializable{
  ...
  @Comment("")
  @StringColumn(name = "SEND_ID", nullable=false, type = StringType.VARCHAR)
  String sendId;

  @Comment("")
  @StringColumn(name = "RECEICE_ID", nullable=false, type = StringType.VARCHAR)
  String receiceId;

  @Comment("")
  @StringColumn(name = "MESSAGE", nullable=true, type = StringType.VARCHAR)
  String message;
