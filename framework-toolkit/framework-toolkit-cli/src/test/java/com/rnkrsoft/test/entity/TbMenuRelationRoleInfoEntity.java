...
@AllArgsConstructor
@ToString
@Table(name = "tb_menu_relation_role_info")
@Comment("菜单关联角色表")
public class TbMenuRelationRoleInfoEntity implements Serializable{
  ...
  @Comment("菜单id")
  @StringColumn(name = "MEMU_ID", nullable=false, type = StringType.VARCHAR)
  String memuId;
