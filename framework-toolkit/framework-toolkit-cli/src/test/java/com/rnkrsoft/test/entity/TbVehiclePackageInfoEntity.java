...
@AllArgsConstructor
@ToString
@Table(name = "tb_vehicle_package_info")
@Comment("车辆套餐表")
public class TbVehiclePackageInfoEntity implements Serializable{
  ...
  @Comment("套餐名称")
  @NumberColumn(name = "NAME", nullable= false, type = NumberType.INTEGER)
  Integer name;

  @Comment("套餐金额")
  @NumberColumn(name = "PRICE", nullable= false, type = NumberType.INTEGER)
  Integer price;

  @Comment("优惠金额")
  @NumberColumn(name = "BENEFIT", nullable= true, type = NumberType.INTEGER)
  Integer benefit;

  @Comment("实际金额")
  @NumberColumn(name = "ACTUAL_PRICE", nullable= false, type = NumberType.INTEGER)
  Integer actualPrice;
