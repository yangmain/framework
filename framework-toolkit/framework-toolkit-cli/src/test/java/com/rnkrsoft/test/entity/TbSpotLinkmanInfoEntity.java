...
@AllArgsConstructor
@ToString
@Table(name = "tb_spot_linkman_info")
@Comment("商户联系人信息表")
public class TbSpotLinkmanInfoEntity implements Serializable{
  ...
  @Comment("合同编号")
  @StringColumn(name = "CONTRACT", nullable=true, type = StringType.VARCHAR)
  String contract;
