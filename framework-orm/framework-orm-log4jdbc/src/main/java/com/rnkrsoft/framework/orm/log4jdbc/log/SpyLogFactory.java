...
import com.rnkrsoft.framework.orm.log4jdbc.log.log4j2.Log4j2SpyLogDelegator;
...
public class SpyLogFactory {
     ...
     * using thenet.sf.log4jdbc.log4j2.Properties#getSpyLogDelegatorName()
     * If the name is <code>null</code>, load net.sf.log4jdbc.log4j2.Log4j2SpyLogDelegator
     ...
     * If <code>null</code>, load net.sf.log4jdbc.log4j2.Log4j2SpyLogDelegator,
     * otherwise, try to load the corresponding class.  
     *
     ...
     * net.sf.log4jdbc.log4j2.Log4j2SpyLogDelegator
     */
