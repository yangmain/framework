package com.rnkrsoft.framework.orm.log4jdbc.log.log4j2;

import com.rnkrsoft.framework.orm.log4jdbc.Properties;
import com.rnkrsoft.framework.orm.log4jdbc.log.SpyLogDelegator;
import com.rnkrsoft.framework.orm.log4jdbc.log.log4j2.message.ConnectionMessage;
import com.rnkrsoft.framework.orm.log4jdbc.log.log4j2.message.ExceptionOccuredMessage;
import com.rnkrsoft.framework.orm.log4jdbc.log.log4j2.message.MethodReturnedMessage;
import com.rnkrsoft.framework.orm.log4jdbc.log.log4j2.message.SqlTimingOccurredMessage;
...
import com.rnkrsoft.framework.orm.log4jdbc.sql.resultsetcollector.ResultSetCollectorPrinter;
...
public class Log4j2SpyLogDelegator implements SpyLogDelegator {
    ...
    @Override
    public void exceptionOccurred(Spy spy, String methodCall, Exception e,
