...
public class LockByForUpdateAndMappedStatementBuilder extends MappedStatementBuilder {
    ...
    public LockByForUpdateAndMappedStatementBuilder(Configuration config, OrmConfig ormConfig, Class mapperClass) {
    ...
    public MappedStatement build() {
        ...
        for (String column : fields.keySet()) {
            ...
            String whereSql = convert(" AND ", getOrmConfig().getKeywordMode()) + convert(columnMetadata.getJdbcName(), getOrmConfig().getSqlMode()) + " = #{" + columnMetadata.getJavaName() + ":" + columnMetadata.getJdbcType().getCode()+ " }";
        ...
        SqlNode forUpdateSqlNode = new StaticTextSqlNode(convert(" FOR UPDATE", getOrmConfig().getKeywordMode()));
