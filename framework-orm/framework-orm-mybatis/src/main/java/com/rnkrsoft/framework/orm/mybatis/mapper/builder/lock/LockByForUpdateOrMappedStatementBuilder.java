...
public class LockByForUpdateOrMappedStatementBuilder extends MappedStatementBuilder {
    public LockByForUpdateOrMappedStatementBuilder(Configuration config, OrmConfig ormConfig, Class mapperClass) {
    ...
    public MappedStatement build() {
        ...
        for (String column : fields.keySet()) {
            ...
            String whereSql = KeywordsUtils.convert(" OR ", getOrmConfig().getKeywordMode()) + KeywordsUtils.convert(columnMetadata.getJdbcName(), getOrmConfig().getSqlMode()) + " = #{" + columnMetadata.getJavaName() + ":" + columnMetadata.getJdbcType().getCode() + " }";
        ...
        SqlNode forUpdateSqlNode = new StaticTextSqlNode(KeywordsUtils.convert(" FOR UPDATE", getOrmConfig().getKeywordMode()));
